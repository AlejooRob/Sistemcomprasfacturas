...
class ComprasEnc(ClassModel):
    ...
    subtotal_iva=models.FloatField(default=0)
...
class ComprasDet(ClassModel):
    ...
    def save(self):
        ...
        self.subtotal_iva=float(self.total * 0.12)
        self.total_iva=self.subtotal_iva + self.total
